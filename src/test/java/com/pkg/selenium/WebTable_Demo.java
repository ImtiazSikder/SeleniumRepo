...
public class WebTable_Demo {
	...
	public static void main(String[] args) {
		...
		int rowNumber=getRowNumberWithCellData("//table[@class='ws-table-all']",company,"xpath");
		Assert.assertTrue(rowNumber !=-1, "Company name not in the table - "+company);
		
		//String price=driver.findElement(By.xpath("//table[@class='ws-table-all']/tbody/tr["+rowNumber+"]/td[3]")).getText();
